object frmMonitorPensiun: TfrmMonitorPensiun
  Left = 303
  Top = 75
  Width = 825
  Height = 480
  Caption = 'Monitoring Pegawai Pensiun'
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object SMDBGrid1: TSMDBGrid
      ...
      Columns = <
        ...
        item
          Expanded = False
          FieldName = 'TGL_PENSIUN'
          Title.Alignment = taCenter
          Title.Caption = 'Tgl BUP'
          Width = 80
          Visible = True
        end
        item
  ...
  object qryPensiun: TADOQuery
    ...
    object qryPensiunSisaBulan: TIntegerField
    ...
    object qryPensiunISTAMBAH_BUP: TBooleanField
      FieldName = 'ISTAMBAH_BUP'
    end
    object qryPensiunTGLTAMBAH_BUP: TDateTimeField
      FieldName = 'TGLTAMBAH_BUP'
    end
    object qryPensiunTGL_PENSIUN: TDateTimeField
      FieldName = 'TGL_PENSIUN'
      ReadOnly = True
    end
