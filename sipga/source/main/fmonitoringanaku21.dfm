object frmAnakU21: TfrmAnakU21
  Left = 308
  Top = 83
  Width = 867
  Height = 574
  Caption = 'Monitoring Anak Usia 21'
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object SMDBGrid1: TSMDBGrid
      ...
      ExOptions = [eoBooleanAsCheckBox, eoCellHint, eoDisableDelete, eoDisableInsert, eoENTERlikeTAB, eoFixedLikeColumn, eoKeepSelection, eoDrawBands, eoFilterAutoApply, eoTitleLines]
      ...
      Columns = <
        ...
        item
          Expanded = False
          FieldName = 'TanggalPutus'
          Title.Alignment = taCenter
          Title.Caption = 'Tgl Hapus'
          Width = 82
          Visible = True
          BandIndex = 0
        end>
  ...
  object qryPensiun: TADOQuery
    ...
    object qryPensiunNO_URUT: TSmallintField
      FieldName = 'NO_URUT'
    end
    object qryPensiunNamaTerTanggung: TStringField
      FieldName = 'NamaTerTanggung'
      Size = 100
    end
    object qryPensiunTanggalLahir: TDateTimeField
      FieldName = 'TanggalLahir'
    end
    object qryPensiunHUB_KD: TStringField
      FieldName = 'HUB_KD'
      Size = 2
    end
    object qryPensiunHUB_NAMA: TStringField
      FieldName = 'HUB_NAMA'
      Size = 15
    end
    object qryPensiunISTANGGUNG: TBooleanField
      FieldName = 'ISTANGGUNG'
    end
    object qryPensiunKETERANGAN: TStringField
      FieldName = 'KETERANGAN'
      Size = 50
    end
    object qryPensiunISSEKOLAH: TBooleanField
      FieldName = 'ISSEKOLAH'
    end
    object qryPensiunPEKERJAAN: TStringField
      FieldName = 'PEKERJAAN'
      Size = 50
    end
    object qryPensiunTGLPUTUSTUNJ: TDateTimeField
      FieldName = 'TGLPUTUSTUNJ'
    end
    object qryPensiunNMSEKOLAH: TStringField
      FieldName = 'NMSEKOLAH'
      Size = 50
    end
    ...
    object qryPensiunTanggalPutus: TDateTimeField
      FieldKind = fkCalculated
      FieldName = 'TanggalPutus'
      Calculated = True
    end
