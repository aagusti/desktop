object frmProses: TfrmProses
  ...
  object QryJENIS: TADOQuery
    ...
    SQL.Strings = (
      ...
      'WHERE JENIS<4'
      'AND TAHUN='#39'THN'#39
      'ORDER BY TAHUN DESC,BULAN DESC,JENIS')
    Left = 528
    Top = 24
  end
  ...
  object qrygajipegawai: TADOQuery
    ...
    object qrygajipegawaiTGL_GAJI: TDateTimeField
      FieldName = 'TGL_GAJI'
    end
    object qrygajipegawaiTMT_FUNGSI: TDateTimeField
      FieldName = 'TMT_FUNGSI'
    end
    object qrygajipegawaiPENERIMA_UDWUDT: TStringField
      FieldName = 'PENERIMA_UDWUDT'
      Size = 50
    end
    object qrygajipegawaiTGLBYR_UDWUDT: TDateTimeField
