object frmGajiInduk: TfrmGajiInduk
  Left = 298
  Top = 39
  Width = 960
  Height = 663
  Caption = 'Proses Gaji Induk'
  Color = clBtnFace
  ...
  object PGCDetail: TPageControl
    ...
    object TabSheet7: TTabSheet
      ...
      object pnlUDWUDT: TPanel
        ...
        BevelOuter = bvNone
        TabOrder = 29
        object LBPenerima: TLabel
          Left = 5
          Top = 16
          Width = 127
          Height = 13
          Alignment = taRightJustify
          Caption = 'Penerima UDW / UDT'
          FocusControl = Penerima
        end
        object LBTGLHITUNG: TLabel
          Left = 11
          Top = 36
          Width = 121
          Height = 13
          Alignment = taRightJustify
          Caption = 'Tanggal UDW / UDT'
        end
        object btnCariTanggungan: TSpeedButton
          Left = 360
          Top = 10
          Width = 23
          Height = 19
        ...
        object Penerima: TDBEdit
          Left = 144
          Top = 10
          Width = 213
          Height = 19
          Ctl3D = False
          DataField = 'PENERIMA_UDWUDT'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          Font.Height = -11
          Font.Name = 'MS Sans Serif'
        ...
        object tglUDWUDT: TDBDateEdit
          Left = 144
          Top = 30
          Width = 125
          Height = 19
          DataField = 'TGLBYR_UDWUDT'
          Color = 14803425
          Ctl3D = False
          DialogTitle = 'Pilih Tanggal'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          Font.Height = -11
          Font.Name = 'MS Sans Serif'
  ...
  object Pegawai: TADOQuery
    ...
    object PegawaiPENERIMA_UDWUDT: TStringField
      FieldName = 'PENERIMA_UDWUDT'
      Size = 100
    end
    object PegawaiTGLBYR_UDWUDT: TDateTimeField
      FieldName = 'TGLBYR_UDWUDT'
    end
  ...
  object QryJENIS: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'SELECT * FROM PEGAWAI_GAJI_JENIS '
      ''
