object frmTunjOtsus: TfrmTunjOtsus
  Left = 471
  Top = 50
  Width = 580
  Height = 480
  Caption = 'Tunjangan Otonomi Khusus'
  Color = clBtnFace
  ...
  object SMDBGrid1: TSMDBGrid
    ...
    Columns = <
      ...
      item
        ...
        FieldName = 'JUMLAH'
        Title.Alignment = taCenter
        Title.Caption = 'Tunjangan'
        Width = 178
        Visible = True
        BandIndex = 0
      end>
  end
  object dsTunjOtsus: TDataSource
    DataSet = TunjOtsus
    Left = 336
    Top = 224
  end
  object TunjOtsus: TADOQuery
    Connection = GModule.conn
    CursorType = ctStatic
    AfterOpen = TunjOtsusAfterOpen
    Parameters = <>
    SQL.Strings = (
