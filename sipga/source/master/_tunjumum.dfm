object frmTunjUmum: TfrmTunjUmum
  Left = 335
  Top = 34
  Width = 580
  Height = 480
  Caption = 'Tunjangan Umum Pegawai'
  Color = clBtnFace
  ...
  object dsTunjUmum: TDataSource
    AutoEdit = False
    DataSet = TunjUmum
    Left = 336
    Top = 224
  end
  object TunjUmum: TADOQuery
    Connection = GModule.conn
    CursorType = ctStatic
    AfterOpen = TunjUmumAfterOpen
    Parameters = <>
    SQL.Strings = (
